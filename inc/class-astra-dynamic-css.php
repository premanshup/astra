		...
		public static function return_output( $dynamic_css, $dynamic_css_filtered = '' ) {
			...
			*/
			...
			if ( true === self::anchors_in_css_selectors_heading() ) {
				...
				$mobile_typography = array_merge( $mobile_typography, $mobile_heading_typo );
			}
